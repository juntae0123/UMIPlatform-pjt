...
from schema.contract import (  # noqa: E402
    CONTRACT_VERSION,
    Episode,
    EpisodeMeta,
    read_episode,
...
from build_scene import DEFAULT_CONFIG, build_model, load_config, normalize  # noqa: E402
from exp_log import _git_rev, file_digest, log_run  # noqa: E402
from grasp_check import contact_on_object, gripper_geom_ids  # noqa: E402
from kinematics import solve_pose_ik  # noqa: E402
...
def main() -> None:
    ...
    parser.add_argument("--out", type=Path, default=Path("data/sim_pick_v0"))
